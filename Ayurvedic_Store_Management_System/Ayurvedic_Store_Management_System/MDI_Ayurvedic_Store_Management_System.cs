...
namespace Ayurvedic_Store_Management_System
{
    ...
    {      
        ...
        {
            frm_Category_Report obj = new frm_Category_Report();
            obj.MdiParent = this;
            obj.WindowState = FormWindowState.Maximized;
            obj.Show();
        }

        private void distributorToolStripMenuItem2_Click(object sender, EventArgs e)
        {
        ...
        {
            frm_Add_Product_Report obj = new frm_Add_Product_Report();
            obj.MdiParent = this;
            obj.WindowState = FormWindowState.Maximized;
            obj.Show();
        }
        ...
        {
            frm_Add_Stock_Report obj = new frm_Add_Stock_Report();
            obj.MdiParent = this;
            obj.WindowState = FormWindowState.Maximized;
            obj.Show();
        } 
        ...
        {
            frm_Add_Customer_Report obj = new frm_Add_Customer_Report();
            obj.MdiParent = this;
            obj.WindowState = FormWindowState.Maximized;
            obj.Show();
        }
        ...
        {
            frm_Customer_Bill_Report obj = new frm_Customer_Bill_Report();
            obj.MdiParent = this;
            obj.WindowState = FormWindowState.Maximized;
            obj.Show();
        }
